...
object JazzerTargetQ7 {
  ...
  def fuzzerInitialize(args: Array[String]): Unit = {
    ...
    f = pkg match {
      case "faulty" => examples.faulty.Q7.main
    }

    f_mutant = mutantName.takeRight(2) match {
      case "M0" => examples.mutants.Q7.Q7_M0.main
      case "M1" => examples.mutants.Q7.Q7_M1.main
      case "M2" => examples.mutants.Q7.Q7_M2.main
      case "M3" => examples.mutants.Q7.Q7_M3.main
      case "M4" => examples.mutants.Q7.Q7_M4.main
      case "M5" => examples.mutants.Q7.Q7_M5.main
      case "M6" => examples.mutants.Q7.Q7_M6.main
      case "M7" => examples.mutants.Q7.Q7_M7.main
      case "M8" => examples.mutants.Q7.Q7_M8.main
      case "M9" => examples.mutants.Q7.Q7_M9.main
      case "M10" => examples.mutants.Q7.Q7_M10.main
      case "M11" => examples.mutants.Q7.Q7_M11.main
      case "M12" => examples.mutants.Q7.Q7_M12.main
      case "M13" => examples.mutants.Q7.Q7_M13.main
      case "M14" => examples.mutants.Q7.Q7_M14.main
    }
