...
object JazzerTargetQ20 {
  ...
  def fuzzerInitialize(args: Array[String]): Unit = {
    ...
    f = pkg match {
      case "faulty" => examples.faulty.Q20.main
    }

    f_mutant = mutantName.takeRight(2) match {
      case "M0" => examples.mutants.Q20.Q20_M0.main
      case "M1" => examples.mutants.Q20.Q20_M1.main
      case "M2" => examples.mutants.Q20.Q20_M2.main
    }
