...
object JazzerTargetQ15 {
  ...
  def fuzzerInitialize(args: Array[String]): Unit = {
    ...
    f = pkg match {
      case "faulty" => examples.faulty.Q15.main
    }

    f_mutant = mutantName.takeRight(2) match {
      case "M0" => examples.mutants.Q15.Q15_M0.main
      case "M1" => examples.mutants.Q15.Q15_M1.main
      case "M2" => examples.mutants.Q15.Q15_M2.main
      case "M3" => examples.mutants.Q15.Q15_M3.main
      case "M4" => examples.mutants.Q15.Q15_M4.main
      case "M5" => examples.mutants.Q15.Q15_M5.main
    }
