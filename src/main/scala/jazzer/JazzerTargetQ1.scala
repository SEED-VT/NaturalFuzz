...
object JazzerTargetQ1 {
  ...
  def fuzzerInitialize(args: Array[String]): Unit = {
    ...
    f_mutant = mutantName.takeRight(2) match {
      case "M0" => examples.mutants.Q1.Q1_M0.main
      case "M1" => examples.mutants.Q1.Q1_M1.main
      case "M2" => examples.mutants.Q1.Q1_M2.main
      case "M3" => examples.mutants.Q1.Q1_M3.main
      case "M4" => examples.mutants.Q1.Q1_M4.main
      case "M5" => examples.mutants.Q1.Q1_M5.main
      case "M6" => examples.mutants.Q1.Q1_M6.main
      case "M7" => examples.mutants.Q1.Q1_M7.main
      case "M8" => examples.mutants.Q1.Q1_M8.main
    }
